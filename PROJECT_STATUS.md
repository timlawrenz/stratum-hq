...
**Last updated:** 2026-08-10 (body-volume #96 capability-probed → BLOCKED with measured numbers — whole-body volume coverage below the pre-registered floor on this portrait/crop-heavy cohort; 5 new proposals #109–#113 registered (brainstorm-new-data); **bangs-forehead #110 ACTIVE** — capability/band probe 22/24 measured (bangs 4 / partial 9 / swept-back 9, max_share 0.409), plan+manifest frozen, 96-caption round-trip queued)
**Phase / status:** ACTIVE — empirical Stage-B loop running; **30 validated** (27 goal feeders + goal arm dossier-context4k + reconstruction + hair-texture #94) + **1 active (bangs-forehead #110)** + **4 blocked (eyewear #105, waist-shape #106, lip-color #107, body-volume #96) + 4 proposals (#109/#111/#112/#113)**; goal inputs 87.5% validated, `goal_unreachable: false` (floor 4001, `any_max_honest_floor_reached` 24/24).
...
**2026-08-10 — REGISTRY TERMINAL → BRAINSTORM-NEW-DATA WIDEN (#109–#113).** With body-volume #96 blocked the selector reported `no actionable proposal — registry is terminal; run brainstorm-new-data` (30 validated / 4 blocked / 0 active / 0 proposals). Five genuinely-new candidates registered 2026-08-10 via the gated `propose-dimensions --require-new-evidence-part` channel, each naming a NEW evidence part or NEW model class measurable on the portrait/crop-heavy cohort (non-redundant with the 30 validated axes): **#109 hand-gesture** (NEW model class MediaPipe Hands 21-pt), **#110 bangs-forehead** (NEW deterministic part, seg2 Hair over the eye-line-anchored forehead band), **#111 eyebrow-position** (NEW part, facemesh brow elevation), **#112 jewelry** (NEW part + CLIP zero-shot on ear/neck crops), **#113 eye-openness** (NEW part, eyelid/iris state). Selector picked **bangs-forehead #110** (exploit, EIG 0.55, novelty +0.15, selection_progress 31); `autonomous-tick --write` activated it.

**2026-08-10 — BANGS-FOREHEAD #110 ACTIVE — capability/band probe PASS, round-trip queued.** `research_harness/bangs_forehead.py`: deterministic band (bangs / partial-fringe / swept-back) from seg2 DOME-29 Hair over a forehead band anchored to the pose2 GOLIATH-308 eye line (0.20 face-heights above the eyes; replaced the fragile Face_Neck-top-anchored strip that absented 13/24). Frozen-cohort probe: **22/24 measured, bangs 4 / partial-fringe 9 / swept-back 9, max_share 0.409 (<0.75), coverage 0.0–0.483** → calibration PASS (probe: `/mnt/nas-ai-models/research/stratum/bangs-forehead-calibration-probe.json`). Frozen plan `stage-b-first500-bangs-forehead-v1` + manifest `stage-b-bangs-forehead-v1` (96 records, 4090) valid. **Round-trip generation queued on the 4090 via the launcher → independent review → `autonomous-tick`.**
...
- **Registry** (`research/dimensions/evidence-dimension-registry-v1.json`): **30 validated** (body-type, clothing, hair, skin-color, lighting, dossier-context4k #36, setting #34, texture #35, reconstruction #37, vlm-dense-description #47, pose-articulation #62, pointmap-depth #58, matting-alpha #59, face-geometry #60, object-relations #61, scene-category #69, gaze-head-orientation #68, apparent-age #73, camera-viewing-angle #74, image-focus-depth-of-field #75, affordance-contact #76, iris-eye-color #80, facial-expression #81, hairstyle #82, body-configuration #83, face-visibility #84, environment-clearance #85, image-quality #95, garment-type #97, hair-texture #94),
  **1 active (body-volume #96, Anny re-scope) + 3 blocked (eyewear #105, waist-shape #106, lip-color #107 — all measured degenerate) + 0 proposals**.
...
**Complete the active arm: bangs-forehead #110 (`research:active`) round-trip.** The capability/band probe PASSED (22/24 measured, bangs 4 / partial 9 / swept-back 9, max_share 0.409) and the plan `stage-b-first500-bangs-forehead-v1` + manifest are frozen and valid. The 96-caption round-trip is running on the 4090 via the launcher → then run the parameterized review wrapper (`stratum_review_poll_wrapper.py --run-root /mnt/nas-ai-models/research/stratum/stage-b-bangs-forehead-v1 --review-root .../stage-b-bangs-forehead-v1-review --job-id stratum-stage-b-bangs-forehead-v1`) → then `autonomous-tick --review-dir-from <tick-ready>` → verdict + label-sync. Non-blocking: the small decisions on blocked arms #96/#105/#106/#107 (downgrade / different cohort / drop) are pending; proposals #109/#111/#112/#113 are register-known and next in the selector queue after the active round-trip.
