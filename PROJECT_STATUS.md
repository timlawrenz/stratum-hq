...
**Last updated:** 2026-08-09 (arms #80–#85 + #95 ALL VALIDATED BETTER 2026-08-08, including the program's first strike-1 NOT_BETTER → honest revision → BETTER (arm #95 image-quality); arm #97 garment-type now the sole active arm — plan + GPU manifest frozen, generation job queued behind a 24h manual gaming-block on the 4090; body-volume #96 open-world sourcing verification in progress while GPU-queued — see `docs/body-volume-sourcing-2026-08-09.md`)
