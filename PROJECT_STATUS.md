...
**Last updated:** 2026-08-11 03:10Z (GPU root-cause SHIFT measured: image_embed EXITED → 4090 free ~21.86 GiB; the 22 GB eyebrow #111 claim is now only ~0.14 GiB short, held by desktop display VRAM (Chrome 1131 MiB, gnome-shell, steamwebhelper); eyebrow resume verified from the pinned eyebrow branch; extended poller running; queue-expiry deadline ~17:50Z today; no registry change — #111 sole active, one-active invariant)
