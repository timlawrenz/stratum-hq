...
try:
    ds_depth = wds.WebDataset(urls_depth, shardshuffle=False).to_tuple("__key__", "depth.npy")
    ds_pose = wds.WebDataset(urls_pose, shardshuffle=False).to_tuple("__key__", "pose.npy")
